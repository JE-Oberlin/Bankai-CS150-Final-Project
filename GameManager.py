...
class GameManager:
    ...
    def __init__(self):
        ...
        self.quitButton = Button(self.screen, 680, 375, self.quit,
                                 "Quit", width=40, height=20, size=10, xOffset=5, yOffset=6)
    ...
    def genSkillButtons(self):
        ...
        for move in self.ichigo.attacks:
            end.append(Button(self.screen, 300, y,
                       self.damageAizen, move.name, arg=move))
            y += 50
    ...
    def genItemButtons(self):
        ...
        for i, n in self.ichigo.inventory.items():
            end.append(Button(self.screen, 300, y, i.use, i.name + str(n)))
